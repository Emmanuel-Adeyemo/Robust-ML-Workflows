...
y. The post-transformation CV $R^2$ was 0.44, 
    
3. Feature Engineering: Introducing higher-order and interaction terms led to a jump in features from  15 to 136.
This surge initially resulted in poorer metrics compared to the baseline. This is probably a result of 
...
b. High variance: In an attempt to increase the model complexity, features with higher other degrees were introduced
which led to severe overfitting, with the metric performing significantly poorer than the simplistic baseline
model. 
...
Lastly, the top 20 influential features involve a combination of main, quadratic, and interaction effects,
