...
c. Lasso vs Baseline Model Performance of Test Data: The lasso model resulted in an $R2$ of 0.55 on the test (held-out) data
while the baseline model was only able to achieve an $R2$ of 0.3,9 even though it has a CV $R2$ of 0.47. The regularized model
